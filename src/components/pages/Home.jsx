  ...
  return (
    <>
     ...
     <Carousel
      ...
      <div className='h-[80vh] bg-green-100 flex -my-14 home 2'>
     <div className=' w-full md:w-[60%] bg-white h-[70%] my-auto rounded-r-[100px] flex flex-col justify-center  '> 
      <section className='w-full md:w-[70%] mx-auto pr-28 break-all contain'>
     ...
     <img src='https://ecoyaan.com/images/Impact.png' alt='image2' className=' joinImage h-[46vh] w-[40%] relative top-[18%] md:w-auto'/>     
      </div>
      
      
      <div className='h-[80vh] bg-green-100 flex home3'>
     ...
     <p className='text-xl flex-wrap '>Soon, we will be connecting you with eco-friendly and sustainable products that are carefully selected based on their environmental and social benefits.</p>
      ...
      <div className='h-[80vh] bg-green-100 flex -my-14 home4'>
