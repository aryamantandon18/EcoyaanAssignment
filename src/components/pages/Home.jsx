  ...
  return (
    <>
     ...
     <div className=' box w-full lg:w-[60%] bg-white h-[70%] my-auto lg:rounded-r-[100px] flex flex-col justify-center '> 
      ...
      <p className='boxHeading text-xl lg:text-4xl font-sans font-semibold flex flex-wrap lg:tracking-wide mb-6'>Join our community in creating a more sustainable future for everyone</p>
