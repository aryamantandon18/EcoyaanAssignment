...
<div className='bg-indigo-50 w-[100%]  md:h-[80vh] flex px-4 md:px-28 py-12 flex-col'>
     ...
     <div className='flex md:flex-row flex-col'>
      ...
      <div className='text-justify'>
        <p className='md:text-2xl mx-9 my-8 font-sans font-normal tracking-normal'>We started Ecoyaan after watching an episode of “Our Planet II”, where we saw the devastating impact of plastic pollution and climate change on the albatross birds. That moment ignited our mission.</p>
        <p className='md:text-2xl mx-9 my-8 font-sans font-normal tracking-normal'>Our research suggests that many Indians understand global warming, yet access to sustainable practices and products remains limited. We also noticed that there is a lack of support for eco-friendly businesses.</p>
        <p className='md:text-2xl mx-9 my-8 font-sans font-normal tracking-normal'>We created Ecoyaan to connect consumers, businesses, and sustainability experts. We want to make it easy and convenient for people to access eco-friendly products and services, learn and share best practices, and support sustainability initiatives.</p>
        <p className='md:text-2xl mx-9 my-8 font-sans font-normal tracking-normal'>As founders, we are not perfect, but we are passionate. We believe that every small step matters. Join us and be a part of the Ecoyaan community — together, we’ll make a difference.</p>
        <p className='md:text-2xl mx-9 my-8 font-sans font-normal tracking-normal'>Connect with the founders on LinkedIn here:<Link>Abhishek Rao</Link> <Link>Sarwanjeet Singh</Link></p>
      </div>
      </div>
     </div>

     <div className='bg-[#fefce8] md:w-[100%] md:h-[120vh] flex px-4 md:px-28 py-12 flex-col gap-6'>
